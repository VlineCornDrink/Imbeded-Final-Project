...
//	char tx_msg[60] = "yes";
  ...
  MX_I2C1_Init();
   ...
   char *text_forward = "Forward";
   char *text_backward = "Backward";
   char *text_stop = "Stop";
   char text_car[16] = "23XA 485";
    ...
    /* USER CODE BEGIN 3 */
		...
		if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_12)) {
			...
			__HAL_TIM_SetCompare(&htim3, TIM_CHANNEL_4, 50);
					  ...
					  lcd_put_cur(0, 0);
					  lcd_send_string(text_forward);
					  lcd_put_cur(1, 0);
					  lcd_send_string(text_car);
...
//								  lcd_put_cur(1, 0);
//								  lcd_send_string(text_car);
//								  memset(text_car,0,sizeof(text_car));
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : btn_backward_Pin btn_forward_Pin */
  GPIO_InitStruct.Pin = btn_backward_Pin|btn_forward_Pin;
